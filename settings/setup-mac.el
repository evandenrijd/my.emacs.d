...
;;-- BEGIN Default Mac OS X MANPATH -------------------------------------------------------
(setq mac-osx-manpath '("/usr/share/man"
                        "/usr/local/share/man"))
;; Checkout where the XCode stuff is located:
;; van@nycity$ xcode-select -p
;; /Applications/Xcode.app/Contents/Developer
(setq xcode-select-p "/Applications/Xcode.app/Contents/Developer")
;; checkout the manuals you want with:
;; $ find $(xcode-select -p) -name man -type d
;; Add your selection in the following list:
(setq xcode-manpath (eval '(mapcar '(lambda (subdir) (concat xcode-select-p subdir "/usr/share/man"))
                                   '(""
                                     "/Toolchains/XcodeDefault.xctoolchain"
                                     "/Platforms/MacOSX.platform/Developer"
                                     "/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.11.sdk"))))
;; FIXME: should appreciate also the previous MANPATH, this overwrites it!
;; (setq manpath (append mac-osx-manpath xcode-manpath (getenv "MANPATH")))
